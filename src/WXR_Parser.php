...
class WXR_Parser
{
    function parse($file)
    {
        ...
        if (extension_loaded('simplexml')) {
            ...
            if (is_array($result) || 'SimpleXML_parse_error' != $result->get_error_code()) {
                return $result;
            }
        } else {
            if (extension_loaded('xml')) {
                ...
                if (is_array($result) || 'XML_parse_error' != $result->get_error_code()) {
                    return $result;
                }
            }
        }
...
class WXR_Parser_SimpleXML
{
    function parse($file)
    {
        ...
        stream_filter_register('xmlutf8', 'Bolt\Extension\Bolt\Importwxr\ValidUTF8XMLFilter');
